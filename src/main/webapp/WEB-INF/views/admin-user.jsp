        ...
        <table id="activityTable" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/admin-user?action=delete&id=<%=u.getId()%>" class="btn-Del admin-delete-trigger"
                       data-title="Xoá người dùng?"
                       data-desc="Bạn có chắc muốn xoá người dùng '<%=u.getUsername()%>'? Hành động này không thể hoàn tác.">

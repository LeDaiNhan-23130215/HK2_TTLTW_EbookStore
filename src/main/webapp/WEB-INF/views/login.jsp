...
<form action="${pageContext.request.contextPath}/login" method="post">
  <div class="container">
    ...
    <div class="input">
      ...
      <c:choose>
        <c:when test="${error_msg == 'oauth_account'}">
          <div class="error-server oauth-hint">
            <i class="fa-brands fa-google"></i>
            <span>Tài khoản này được liên kết với Google. Vui lòng đăng nhập bằng Google bên dưới.</span>
          </div>
        </c:when>
    ...
    <div class="logoContainer">
      <a href="${pageContext.request.contextPath}/oauth/google/init" class="google-btn">
        ...
        <span class="google-btn-text">Đăng nhập bằng Google</span>
      </a>
    </div>
